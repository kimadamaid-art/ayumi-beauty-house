...
export default function GlobalSidebar() {
    ...
    return (
        <aside className="w-64 bg-gradient-to-b from-ayumi-secondary to-ayumi-primary shadow-lg fixed h-full z-40 flex flex-col hidden md:flex">
            ...
            <div className="p-4 flex-1 overflow-y-auto space-y-1 custom-scrollbar">
                ...
                {dbUser && dbUser.role !== 'therapist' ? (
                    <>
                        ...
                        <Link href="/leads">
                            <div className={`flex items-center gap-3 px-3 py-3 rounded-xl transition-all font-semibold cursor-pointer ${isActive('/leads') ? 'bg-white text-ayumi-primary shadow-md' : 'text-white/70 hover:bg-white/10 hover:text-white'}`}>
