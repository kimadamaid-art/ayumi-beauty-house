    ...
    return (
        <div className="p-6 md:p-8 max-w-6xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 card-ayumi p-6">
                <div>
                    <h1 className="text-2xl font-extrabold text-ayumi-text mb-1">Riwayat Treatment</h1>
                    <p className="text-sm text-ayumi-text-muted">Semua treatment yang pernah Anda tangani.</p>
                </div>
