...
function AddRecordForm() {
    ...
    const [formData, setFormData] = useState({
        ...
        treatment_time: new Date().toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' }),
        complaints: '',
        skin_condition: '',
        result_notes: '',
        recommendation: ''
    ...
    const handleAddTreatment = (treatmentId, couponItem = null) => {
        ...
        setSelectedTreatments(prev => [
            ...prev,
            {
                treatment_id: t.id,
                name: t.name,
                price_at_time: couponItem ? 0 : (t.price || 0),
                original_price: couponItem ? 0 : (t.price || 0),
                discount_percent: 0,
            ...
            selectedTreatments.forEach((t, index) => {
                ...
                if (t.used_coupon_item_id) {
                    couponLogsToInsert.push({
                        patient_coupon_id: t.used_patient_coupon_id,
