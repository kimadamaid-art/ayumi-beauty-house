...
export default function TreatmentRecordDetailPage() {
    ...
    useEffect(() => {
        ...
        const fetchDetails = async () => {
            ...
            // 1. Fetch Record with nested Patient, Provider, Branch, and Transactions
                            ...
                            <div className="flex flex-wrap gap-2 items-center">
                                {paidTx ? (
                                    <Link href={`/kasir/transactions/${paidTx.id}`}>
                                        <button className="bg-sky-50 text-sky-700 border border-sky-300 hover:bg-sky-100 px-4 py-2.5 rounded-xl font-bold text-sm transition-colors flex items-center gap-2 shadow-2xs">
                                            ...
                                            Lihat Struk ({paidTx.transaction_number})
                                        </button>
                                    </Link>
                                ) : (
