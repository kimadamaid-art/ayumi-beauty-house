        ...
        <div className="space-y-6 relative">
            ...
            <div className="flex justify-end items-center mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="card-ayumi p-6 flex items-center gap-4 bg-gradient-to-br from-green-50 to-emerald-50 border-emerald-100 hover:shadow-md transition-shadow">
                    ...
                    <div className="card-ayumi p-6 flex items-center gap-4 bg-gradient-to-br from-blue-50 to-indigo-50 border-indigo-100 hover:shadow-md transition-shadow">
                    ...
                    <div className="card-ayumi p-6 flex items-center gap-4 bg-gradient-to-br from-pink-50 to-rose-50 border-rose-100 hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    {/* Widget 1 */}
                    <div className="card-ayumi p-6 flex items-center gap-4 hover:shadow-md transition-shadow">
