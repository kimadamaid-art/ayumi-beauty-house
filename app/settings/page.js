                ...
                {dbUser?.role === 'owner' && (
                    <>
                        ...
                        <Link href="/settings/branches">
                            <div className="p-4 md:p-6 border-2 border-gray-100 rounded-2xl hover:border-blue-300 hover:bg-blue-50 transition-all cursor-pointer group h-full bg-white">
                        ...
                        <Link href="/settings/users">
                            <div className="p-4 md:p-6 border-2 border-gray-100 rounded-2xl hover:border-green-300 hover:bg-green-50 transition-all cursor-pointer group h-full bg-white">
                        ...
                        <Link href="/settings/treatment-categories">
                            <div className="p-4 md:p-6 border-2 border-gray-100 rounded-2xl hover:border-pink-300 hover:bg-pink-50 transition-all cursor-pointer group h-full bg-white">
                        ...
                        <Link href="/settings/treatments">
                            <div className="p-4 md:p-6 border-2 border-gray-100 rounded-2xl hover:border-purple-300 hover:bg-purple-50 transition-all cursor-pointer group h-full bg-white">
                        ...
                        <Link href="/settings/workers">
                            <div className="p-4 md:p-6 border-2 border-gray-100 rounded-2xl hover:border-amber-300 hover:bg-amber-50 transition-all cursor-pointer group h-full bg-white">
                                ...
                                <h3 className="text-lg font-bold text-gray-800 mb-1 group-hover:text-amber-600 transition-colors">Daftar Worker</h3>
                                <p className="text-sm text-gray-500">Kelola tenaga infus dan tindakan sejenis yang upahnya dihitung per tindakan dalam rupiah.</p>
                            </div>
                        </Link>
