                ...
                <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4 backdrop-blur-sm overflow-y-auto">
                    <div className="bg-white rounded-3xl max-w-lg w-full p-6 md:p-8 shadow-2xl border border-gray-100 my-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1.5">Catatan Staf (Opsional)</label>
                                <input 
                                    type="text"
                                    value={waForm.notes}
                                    onChange={e => setWaForm({...waForm, notes: e.target.value})}
                                    className="input-ayumi focus:bg-gray-50 text-sm py-2.5"
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-8 border-t border-gray-100 pt-5">
                            <button 
                                ...
                                className="w-full sm:w-auto px-5 py-2.5 rounded-2xl font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors text-sm cursor-pointer"
                            >
                                Batal
                            </button>
                            <div className="flex flex-col sm:flex-row items-center gap-2.5 w-full sm:w-auto">
                                <button 
                                    ...
                                    className="w-full sm:w-auto px-4 py-2.5 rounded-2xl font-bold text-gray-700 bg-gray-100 hover:bg-gray-200 border border-gray-200 transition-colors text-sm cursor-pointer"
                                >
                                    Hanya Tandai Selesai
                                </button>
                                <button 
                                    onClick={sendWaAndSaveLog} 
                                    className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-2xl font-extrabold transition-all text-sm flex items-center justify-center gap-2 shadow-md shadow-emerald-600/20 cursor-pointer"
                                >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-8 border-t border-gray-100 pt-5">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-2.5 w-full sm:w-auto">
                                ...
                                <button 
                                    ...
                                    className="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-2xl font-bold transition-all text-sm flex items-center justify-center gap-1.5 shadow-md"
                                >
